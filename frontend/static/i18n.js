...
const TRANSLATIONS = {
  ...
  'alert.fillRequired':    { es: 'Rellena los campos obligatorios.', en: 'Please fill in all required fields.' },
  'alert.dniPhoneRequired':{ es: 'DNI y Teléfono son obligatorios para el plan gratuito.', en: 'ID and Phone are required for the free plan.' },
  'alert.welcome':         { es: '¡Bienvenido a Trastevere!', en: 'Welcome to Trastevere!' },
  'alert.connectionError': { es: 'Error de conexión con el servidor.', en: 'Connection error. Please try again.' },
